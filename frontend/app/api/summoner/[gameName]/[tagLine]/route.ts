...
// Use server-side BACKEND_URL (internal) if available, otherwise fall back to NEXT_PUBLIC_BACKEND_URL
// In production, BACKEND_URL should be http://localhost:8000 to avoid external roundtrip
