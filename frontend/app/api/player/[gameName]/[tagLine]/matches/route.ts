...
export async function GET(
  ...
  try {
    ...
    const url = `${BACKEND_URL}/api/player/${encodeURIComponent(gameName)}/${encodeURIComponent(tagLine)}/matches?limit=${limit}`;
    ...
    try {
      ...
      console.log('[API Route] Matches retrieved successfully:', data.total);
